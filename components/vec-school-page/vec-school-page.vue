...
<script>
	export default {
		...
		methods: {
			handleTap(i) {
				uni.navigateTo({
					url: `/pages/indexIcon/schoolDatabase/${this.type=='高职'?'GaozhiPageDetail':'ZhongzhiPageDetail'}?province=${i.name}&provinceId=${i.provinceid}&schoolType=${this.type=='高职'?'1':'2'}`,
